...
export const mockProjects: Project[] = [
  {
    ...
    description: "A decentralized crowdfunding and grant funding platform built on the Stellar blockchain. Enables transparent, milestone-based funding for ambitious projects and public innovation.",
    image: "/banner.png",
  ...
  },
  {
    ...
    description: "A comprehensive DeFi protocol aggregator that provides users with the best yields across multiple chains. Features automated portfolio rebalancing and risk management.",
    image: "/banner.png",
  ...
  },
  {
    ...
    description: "A decentralized NFT marketplace with zero gas fees, built on Layer 2 solutions. Supports multiple blockchains and provides tools for creators to monetize their digital art.",
    image: "/banner.png",
