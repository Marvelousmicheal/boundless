    ...
    <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Full width, bottom sheet, 85% max height, close button at -right-10
              </p>
            </div>
            <div className="text-center">
              <Badge variant="secondary" className="mb-2">Tablet</Badge>
              <p className="text-sm text-muted-foreground">
                Centered with max-width, 80% max height, close button at -right-14
              </p>
            </div>
            <div className="text-center">
              <Badge variant="secondary" className="mb-2">Desktop</Badge>
              <p className="text-sm text-muted-foreground">
                Large max-width (6xl), optimized spacing, close button at -right-14
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <BoundlessSheet open={openBottom} setOpen={setOpenBottom}>
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-white">Welcome to BoundlessSheet</h2>
          <p className="text-gray-300">
            This is a responsive sheet component that adapts to different screen sizes.
      ...
      >
        <div className="space-y-4">
          ...
          <p className="text-gray-300">
            This sheet slides in from the right side. Perfect for navigation menus,
            settings panels, or additional content.
          </p>
          <div className="space-y-3">
            <div className="p-3 bg-white/5 rounded-lg">
              <h4 className="font-medium text-white mb-1">Navigation Item 1</h4>
              <p className="text-sm text-gray-400">Description for navigation item</p>
            </div>
            <div className="p-3 bg-white/5 rounded-lg">
      ...
      >
        <div className="space-y-4">
          <p className="text-gray-300">
            This sheet has a custom title that appears in the header.
            The title is centered and styled consistently.
          </p>
          <Separator className="bg-white/20" />
          ...
          <div className="pt-4">
            <Button 
              onClick={() => setOpenWithTitle(false)}
              className="w-full"
            >
              Confirm Action
            </Button>
      ...
      >
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="text-gray-300">
              This sheet demonstrates custom styling with gradients and enhanced visual design.
            </p>
          </div>
